...
$(document).on('click', '.Enter', function () {
  ...
  // Vérifiez si aucun produit n'est commandé
  if (TotalPriceArr == 0) {
    ...
    // Vérifiez si le champ client est vide
    var customer = $('#customer_search').val().trim();
    if (customer.length == 0) {
        customer = "Guest"; // Valeur par défaut si aucun nom de client n'est fourni
        console.log("No customer entered. Proceeding with default: Guest.");
    }
